...
class Organlar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(title: Text("Organlar")),
        body: Center(
  ...
  List<Kelime> veriKaynaginiHazirla() {
    List<Kelime> gecici = [];
    for (int i = 0; i < 18; i++) {
      var kelimeAdi = Organlars.KELIME_ADLARI[i];
      var kelimeResmi = Organlars.KELIME_RESIMLERI[i];
      var kelimeAnlami = Organlars.KELIME_ANLAMLARI[i];
      var kelimeSesi = Organlars.KELIME_SESLERI[i];
